...
export default function Footer() {
  ...
  const footerLinks = {
    ...
    services: [
      { name: 'Freight Shipping', href: '/services' },
      { name: 'Long Haul', href: '/services' },
      { name: 'Express Delivery', href: '/services' },
    ],
    support: [
      { name: 'Contact Us', href: '/contact-us' },
      { name: 'Get a Quote', href: '/contact-us' },
      { name: 'Track Shipment', href: '/contact-us' },
    ],
  };

  return (
    <footer className="bg-gradient-to-br from-[#0a1f2e] via-[#1B4965] to-[#0a1f2e] text-white">
      {/* Main Footer Content */}
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1 text-center md:text-left">
            ...
            <p className="mt-4 text-sm leading-relaxed text-white/80">
              Your trusted partner for reliable freight shipping and trucking services across the United States.
            </p>
            ...
            <div className="mt-6 space-y-3">
              ...
              <div className="flex items-center justify-center md:justify-start gap-3">
                ...
                <a href="tel:+17048199964" className="text-sm font-medium text-white/90 transition-colors hover:text-white">
                  (704) 819-9964
                </a>
              </div>
            </div>
        ...
        <div className="mt-12 border-t border-white/10 pt-8">
          <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
            <div className="text-center md:text-left">
              <h3 className="text-lg font-semibold text-white">Ready to Ship?</h3>
              <p className="mt-1 text-sm text-white/80">
                Get a free quote today or call us at{' '}
                <a href="tel:+17048199964" className="font-semibold text-white underline decoration-white/40 transition-colors hover:decoration-white">
                  (704) 819-9964
                </a>
              </p>
            </div>
            <div className="flex gap-3">
              <Link
                href="/contact-us"
                className="rounded-lg bg-white px-6 py-3 text-sm font-semibold text-[#1B4965] transition-all duration-200 hover:bg-white/90 hover:shadow-lg"
              >
                Get a Quote
              </Link>
              <a
                href="tel:+17048199964"
                className="rounded-lg border-2 border-white/40 bg-white/10 px-6 py-3 text-sm font-semibold text-white backdrop-blur-sm transition-all duration-200 hover:border-white/60 hover:bg-white/20"
              >
                Call Now
              </a>
            </div>
      ...
      <div className="border-t border-white/10 bg-black/20">
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center justify-between gap-4 text-sm text-white/70 md:flex-row">
            <p>
              © {currentYear} NIFE Transport Services LLC. All rights reserved.
            </p>
